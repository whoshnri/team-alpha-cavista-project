    ...
    return (
        <div className="flex flex-col items-start w-full">
            <div className="w-full card-overhaul">
                ...
                <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h4 className="text-sm font-bold text-white uppercase tracking-tight">{config.title}</h4>
                        </div>
                    </div>
                    <button
                        onClick={onDismiss}
                        className="p-1 rounded-lg text-[#505050] hover:text-white transition-colors"
                    >
                        <X className="h-4 w-4" />
                    </button>
                </div>
                ...
                {toolReason && (
                    <p className="text-xs text-[#505050] font-medium mb-6 pl-4 border-l border-border">
                        "{toolReason}"
                    </p>
                )}
                ...
                {denied ? (
                    <div className="space-y-4">
                        <div className="p-4 border border-[#ff4444]/20 bg-[#ff4444]/10 rounded-lg">
                            <p className="text-xs text-[#ff4444] font-medium leading-relaxed">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={onGrant}
                            disabled={loading}
                            className="button-primary flex-1 h-11"
                        >
                            {loading ? (

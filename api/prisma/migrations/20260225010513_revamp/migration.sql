...
CREATE TABLE "health_profiles" (
    ...
    "occupation" TEXT,
    "incomeLevel" TEXT,
    "hrBaseline" DOUBLE PRECISION,
    "hrStdDev" DOUBLE PRECISION,
    "hrReadingCount" INTEGER NOT NULL DEFAULT 0,
    "hrvBaseline" DOUBLE PRECISION,
    "hrvStdDev" DOUBLE PRECISION,
    "gaitRegularityBase" DOUBLE PRECISION,
    "gaitRegularityStdDev" DOUBLE PRECISION,
    "fatigueIndexBase" DOUBLE PRECISION,
    "stepsPerWindowBase" DOUBLE PRECISION,
    "respiratoryBase" DOUBLE PRECISION,
    "respiratoryStdDev" DOUBLE PRECISION,
    "dominantActivity" TEXT,
    "avgDailySteps" DOUBLE PRECISION,
    "avgDailyCalories" DOUBLE PRECISION,
    "chronicFatigueRisk" BOOLEAN NOT NULL DEFAULT false,
    "elevatedHRRisk" BOOLEAN NOT NULL DEFAULT false,
    "lowHRVRisk" BOOLEAN NOT NULL DEFAULT false,
    "sedentaryRisk" BOOLEAN NOT NULL DEFAULT false,
    "gaitTrend" TEXT,
    "hrTrend" TEXT,
    "hrvTrend" TEXT,
    "lastRecalibrated" TIMESTAMP(3),
    "totalScans" INTEGER NOT NULL DEFAULT 0,
    "profileConfidence" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "labMetadata" JSONB DEFAULT '{}',
